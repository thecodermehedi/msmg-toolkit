...
- Windows 8.1 / Windows 10 / Windows 11 Host Operating System for Servicing Windows 7 / 8.1 / 10 / 11 (x86/x64) source images.
- Toolkit's component removal engine (ToolkitHelper.exe) requires Microsoft .NET Framework 4.8 or 4.9 runtime pack.
...
[G] - Remove Windows Components using Remove menu.
	  ...
	  [1] If using Remove Windows Components menu then 
		...
		Note: Only for Client (x86 & x64) editions source images with integrated cumulative update specified in the changelog.txt.
